...
export default function Home() {
  ...
  const { data: sliderProducts, isLoading: loadingSlider } = useQuery({
    queryKey: ['products', 'hero-slider'],
    queryFn: () => configService.getHeroSliderProducts(),
    enabled: configs?.heroType === 'slider',
  });
  ...
  const loading = loadingBestSellers || loadingCategories || loadingNewArrivals || loadingBrands || loadingShowroom || (configs?.heroType === 'slider' && loadingSlider);
  ...
  return (
    <div className="flex flex-col items-center w-full bg-background-dark text-white font-display">
      <div className="w-full max-w-[1440px] px-4 md:px-10 pb-10">
        ...
        {/* Categories */}
        {configs?.showCategoriesSection !== false && (
          <div className="py-10">
        ...
        {/* Best Sellers Slider */}
        {configs?.showBestSellersSection !== false && (
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-10 md:p-20 gap-10">
                  <div className="flex flex-col gap-6 max-w-2xl text-center md:text-left">
                    <div className="inline-flex items-center gap-2 self-center md:self-start bg-yellow-400/20 text-yellow-400 px-4 py-1.5 rounded-full text-sm font-bold border border-yellow-400/20">
                      ...
                      {configs?.b2bBadge || t('home.b2b.badge')}
                    </div>
                    <h2 className="text-4xl md:text-5xl font-black text-white leading-tight tracking-tight">
                      {configs?.b2bTitle1 || t('home.b2b.title1')}
                      <br />
                      <span className="text-primary">{configs?.b2bTitle2 || t('home.b2b.title2')}</span>
                    </h2>
                    <p className="text-gray-300 text-lg md:text-xl">
                      {configs?.b2bDescription || t('home.b2b.description')}
                    </p>
        ...
        {configs?.showNewArrivalsSection !== false && (
          <div className="py-12">
        ...
        {configs?.showTestimonialsSection !== false && <Testimonials />}
