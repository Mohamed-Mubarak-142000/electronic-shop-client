    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 gap-4">
                <button type="button" className="flex items-center justify-center gap-2 rounded-full border border-border-dark bg-surface-dark h-12 text-sm font-medium text-white hover:bg-surface-highlight transition-colors">
                    {/* Google Icon SVG */}
