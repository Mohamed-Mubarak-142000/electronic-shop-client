...
export default function OrderDetailsDrawer({ order, onClose }: OrderDetailsDrawerProps) {
    ...
    return (
        <div className="flex flex-col absolute inset-y-0 right-0 w-full md:w-[450px] lg:w-[35%] bg-surface-dark border-l border-white/5 shadow-[-10px_0_30px_rgba(0,0,0,0.5)] z-30">
            {/* Header */}
            <div className="flex flex-col p-6 border-b border-white/5 bg-card-dark">
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        {order.orderItems?.map((item, index) => (
                            <div key={index} className="flex gap-4 p-3 rounded-xl bg-background border border-white/10 hover:border-gray-600 transition-colors">
            ...
            <div className="p-4 border-t border-white/5 bg-card-dark flex gap-3">
